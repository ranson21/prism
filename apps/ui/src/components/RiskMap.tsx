          ...
          <Geographies geography={COUNTIES_URL}>
            {({ geographies }: { geographies: any[] }) =>
              geographies.map((geo: any) => {
                ...
                const strokeWidth = isHighlighted || isSelected ? 1.5 / zoom : 0.4 / zoom
                ...
                const fillOpacity = dimmed
                  ...
                  : county?.risk_score != null
                    ? (isHighlighted ? 1 : scoreFillOpacity(county.risk_score))
                    : 0.25
                  ...
                  <Geography
                    ...
                    style={{
                      default: {
                        fill: fillColor,
                        fillOpacity,
                        stroke: isHighlighted ? '#38bdf8' : isSelected ? '#f8fafc' : 'rgba(51,65,85,0.5)',
                        strokeWidth,
                        outline: 'none',
                        cursor: 'pointer',
                        filter: isSelected ? `drop-shadow(0 0 5px ${glowColor}cc)` : 'none',
                      },
                      hover: {
                        fill: fillColor,
