...
dependency "alb" {
  ...
  mock_outputs = {
    target_group_arns = [
      "arn:aws-us-gov:elasticloadbalancing:us-gov-west-1:123456789012:targetgroup/prism-stable-site/aaa",
      "arn:aws-us-gov:elasticloadbalancing:us-gov-west-1:123456789012:targetgroup/prism-stable-api/bbb",
      "arn:aws-us-gov:elasticloadbalancing:us-gov-west-1:123456789012:targetgroup/prism-stable-ui/ccc",
    ]
  }
  mock_outputs_allowed_terraform_commands = ["validate", "plan"]
}
